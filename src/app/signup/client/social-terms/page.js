...
export default function ClientSocialTermsPage() {
  ...
  const [detailedPrivacyConsent, setDetailedPrivacyConsent] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    // 필수 약관 체크
    if (!serviceTerms || !privacyPolicy || !detailedPrivacyConsent || !sensitiveInfoAndThirdParty) {
    ...
    try {
      ...
      const terms = {
        ...
        detailed_privacy_consent: detailedPrivacyConsent,
        sensitive_info_and_third_party: sensitiveInfoAndThirdParty,
